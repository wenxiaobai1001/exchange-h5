  ...
  <div class="envelope">
    ...
    <div class="input-panel"  v-if="!hasReceived &&  envelopeInfo.state == 0">
      ...
      <Form ref="formInline" inline>
        ...
        <FormItem prop="code">
          ...
          <input id="sendCode" @click="sendCode();" type="Button" shape="circle" :value="sendcodeValue" :disabled='codedisabled'></input>
        </FormItem>
        <FormItem>
    ...
    <div class="record-list">
      ...
      <div class="content">
        ...
        <div class="item clearfix" v-for="(item, index) in envelopeDetailList" :key="index">
...
export default {
  data() {
    return {
      ...
      hasInviteUser: false,
      inviteUserId: "***********",
      inviteUserAvatar: "https://coineurglobalvip.oss-accelerate.aliyuncs.com/assets/images/defaultavatar.png",
      envelopeInfo: {
        id: 0,
        name: "**********",
        totalAmount: "0.00",
        ...
        invite: 0,
        type: 0,
        logo: "https://coineurglobalvip.oss-accelerate.aliyuncs.com/assets/images/applogo.png",
        bgImage: "https://coineurglobalvip.oss-accelerate.aliyuncs.com/assets/images/redenvelope.png",
        state: 0,
        detail: "留给未来一个暴富的可能"
      },
      formInline: {
