<template>
  <div class="page-home">
    ...
    <div class="page-content">
      <div class="page-exchangerecord">
        <div class="rightarea-con">
          <div class="form-group daterange">
            <span style="width: 120px;display: inline-block;">{{$t('uc.finance.record.start')}}:</span>
            <DatePicker v-model="startTime" format="yyyy-MM-dd" type="date" style="width: 200px;" @on-clear="clear"></DatePicker>
          </div>
          <div class="form-group daterange">
            <span style="width: 120px;display: inline-block;">{{$t('uc.finance.record.end')}}:</span>
            <DatePicker v-model="endTime" format="yyyy-MM-dd" type="date" style="width: 200px;" @on-clear="clear"></DatePicker>
          </div>
          <div class="form-group">
            <span style="width: 120px;display: inline-block;">{{$t('uc.finance.record.symbol')}}:</span>
          ...
          <div class="form-group">
            <span style="width: 120px;display: inline-block;">{{$t('uc.finance.record.operatetype')}}:</span>
          ...
          <div class="order-table">
            ...
            <div style="margin: 10px 2px;overflow: hidden">
