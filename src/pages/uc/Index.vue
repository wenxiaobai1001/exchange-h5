     ...
     <div id="pagetips" style="border-bottom:1px solid rgb(28, 39, 58);">
        ...
        <div class="agent-panel">
          ...
          <div class="agent-list">
            <div class="agent-item">
              <div class="agent-img">
                <img v-if="langPram!='zh_CN'" src="../../assets/images/new_1usd.png"></img>
                <img v-if="langPram=='zh_CN'" src="../../assets/images/new_1cny.png"></img>
              </div>
      ...
      <div style="width: 100%;background: #141e2c;display:none;">
        <router-link to="/announcement/118930" target="_blank" style="width: 100%;">
          <img src="https://coineurglobalvip.oss-accelerate.aliyuncs.com/assets/images/bannerimg.png" style="width: 72%;margin-left: 14%;margin-top: 20px;">
        </router-link>
      </div>
      ...
      <div class="section" id="page2">
        ...
        <div class="ptjy">
          <Table :no-data-text="$t('common.nodata')" v-if="choseBtn==0" :columns="favorColumns" :data="dataIndex" class="tables" :disabled-hover="true" :loading="loading"></Table>
          <Table :no-data-text="$t('common.nodata')" v-if="choseBtn!=0" :columns="coins.columns" :data="dataIndex" class="tables" :disabled-hover="true" :loading="loading"></Table>
<!--
          ...
          <Table :no-data-text="$t('common.nodata')" v-if="choseBtn!=0" :columns="coins.columns" :data="dataIndex2" class="tables" :disabled-hover="true" :loading="loading"></Table>
-->
        </div>
      </div>
        ...
        <ul class="download">
          ...
          <li class="wrapper">
            <div class="download_app">
              <img  src="../../assets/images/customized/appdownload.png">
            </div>
            <div class="abstract">
              <div class="content">
                <span></span>
    ...
    <div class="app_bottom">
      <div class="left_logo">
        <img style="float:left;" src="../../assets/images/customized/applogo.png"></img>
...
#page5 {
  ...
  .phone_image {
    ...
    float: left;
    height: 100%;
    background: url("../../assets/images/customized/phone_img.png") no-repeat left 150px;
