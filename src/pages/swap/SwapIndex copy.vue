<template>
  <div class="container swap" :class="skin">
    <div class="main">
      ...
      <div class="tab-menu">
        <span @click="changeTabMenu(1)" :class="{'isActiveMenu':isActiveMenu==1}">Chart</span><span @click="changeTabMenu(2)" :class="{'isActiveMenu':isActiveMenu==2}">Order book</span><span @click="changeTabMenu(3)" :class="{'isActiveMenu':isActiveMenu==3}">Trade history</span>
      </div>
      ...
      <div v-if="isActiveMenu==3" class="left plate-wrap" style="position:relative;">
        ...
        <div class="trade-wrap">
          <Table :no-data-text="$t('common.nodata')" height="472" :columns="trade.columns" :data="trade.rows"></Table>
        </div>
        <!-- 我的合约账户 -->
