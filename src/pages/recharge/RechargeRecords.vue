          ...
          <div class="table-inner action-box open">
            ...
            <div class="action-inner">
              <div class="inner-left">
                ...
                <Select v-model="coinType" style="width:100px;margin-top: 10px;" @on-change="changeCoin" :placeholder="$t('common.pleaseselect')">
              ...
              <div class="inner-box deposit-address">
                ...
                <div class="title">
                  <Input v-model="qrcode.value" readonly style="color:#8c979f;"></Input>
                ...
                <p v-if="accountType != 0" style="margin-top: 10px;font-size:12px;color:#828ea1;">{{$t('uc.finance.recharge.memotips')}}<a style="color: #f0a70a;" v-clipboard:copy="memoCode" v-clipboard:success="onCopy" v-clipboard:error="onError" href="javascript:;" id="copyBtn" class="link-copy">{{$t('uc.finance.recharge.copy')}} Memo</a></p>
              </div>
  ...
  methods: {
    ...
    resetAddress(){
      ...
      if(this.qrcode.value == "" || this.qrcode.value == null || this.qrcode.value == undefined){
        ...
        this.$http
          .post(this.host + "/uc/asset/wallet/reset-address-create", params)
          .then(response => {
            var resp = response.body;
            if (resp.code == 0) {
              setTimeout(function() {
