                      ...
                      <div class="right-container">
                          ...
                          <div class="info">
                              ...
                              <div class="info-item">
                                  ...
                                  <p class="value" style="color:#F90;" v-if="activityDetail.type==1">{{$t('activity.activitytype1')}} <router-link to="/helpdetail?cate=1&id=33&cateTitle=常见问题">{{$t('activity.ruledetail')}}</router-link></p>
                                  <p class="value" style="color:#F90;" v-if="activityDetail.type==2">{{$t('activity.activitytype2')}} <router-link to="/helpdetail?cate=1&id=32&cateTitle=常见问题">{{$t('activity.ruledetail')}}</router-link></p>
                                  <p class="value" style="color:#F90;" v-if="activityDetail.type==3">{{$t('activity.activitytype3')}} <router-link to="/helpdetail?cate=1&id=36&cateTitle=常见问题">{{$t('activity.ruledetail')}}</router-link></p>
                                  <p class="value" style="color:#F90;" v-if="activityDetail.type==4">{{$t('activity.activitytype4')}} <router-link to="/helpdetail?cate=1&id=37&cateTitle=常见问题">{{$t('activity.ruledetail')}}</router-link></p>
                              ...
                              <div class="info-item">
                                  ...
                                  <p class="value" v-if="activityDetail.limitTimes > 0">{{activityDetail.limitTimes}}</p>
  ...
  methods: {
    ...
    getData(){
        ...
        if (res.status == 200 && res.body.code == 0) {
            ...
            window.document.title = (this.lang == "zh_CN" ? "活动 - " : "Activity - ") + this.activityDetail.title + " - PDG | Global Bitcoin trading platform ";
            //持仓瓜分类型进度显示处理
