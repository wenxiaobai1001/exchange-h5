  ...
  <div class="invite">
      ...
      <div class="promotion-tools">
        ...
        <div class="tools">
          <div class="item" @click="showCardItem">
              <img src="../../assets/images/promotion/promotioncard.png"></img>
          ...
          <div class="item" @click="useInviteImage">
              <img src="../../assets/images/promotion/invitebg.png"></img>
    ...
    <Drawer :title="$t('invite.pt_title')" :closable="false" v-model="showCardModal" width="600">
      <div class="ptcard-header">
        <img class="card-img" src="../../assets/images/promotion/promotioncard.png"></img>
        <div class="desc">
    ...
    <Drawer :title="promotionTitle" :closable="false" v-model="showPromotionModal" width="350" style="text-align:center;">
      <div style="position:relative;width: 318px;" id="promotionImage" ref="promotionImage">
        <img style="width:100%;display:block;" src="../../assets/images/promotion/promotionbg1.png"></img>
    ...
    <Drawer :title="$t('invite.context_title3')" :closable="false" v-model="showInviteImageModal" width="350" style="text-align:center;">
      <div style="position:relative;width: 318px;" id="inviteImage" ref="inviteImage">
        <img style="width:100%;display:block;" src="../../assets/images/promotion/invitebg1.png"></img>
