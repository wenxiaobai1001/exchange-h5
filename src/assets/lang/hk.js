module.exports = {
    common: {
        ...
        recharge:"充值",
        withdraw:"提现",
        support:"支持 BTC, USDT, ETH等.",
        helpCenter:"帮助中心",
        noticeCenter:"消息中心",
        customerCenter:"客服",
        innovativeLab:"创新实验室",
        innovativeLabDesc:"投资者、项目方、交易所等多方共赢的开放实验室",
        trend:"趋势",
        marketTrend:"市场行情",
        announcementlist:"通告列表",
        announcementDetail:"通告详细",
        rechargeList:"充值列表",
        rechargeChannels:"请选择以下充值渠道",
        rechargeTip:"提示: 银行充值接口目前正在开发中...，请耐心等待。",
        rehargeThird:"第三方充值渠道",
        goRecharge:"充值",
        thirdChannel:"官方充值渠道",
        rechargeAddress:"充值地址",
        rechargeCustomer:"请联系客服咨询充值地址",
        rechargeCopy:"复制地址",
        rechargeAmount:"充值数量",
        rechargeEvidence:"充值凭证",
        rechargeEvidenceTip:"点击上传充值图片",
        rechargeSave:"提交",
        withdrawList:"提现列表",
        withdrawChannels:"请选择以下提现渠道",
        withdrawTip:"提示: 银行提现接口目前正在开发中...，请耐心等待。",
        goWithdraw:"提现",
        withdrawThird:"第三方提现渠道",
        withdrawThirdChannel:"官方提现渠道",
    ...
    sectionPage: {
        ...
        newsTitle: '多終端APP',
        brandTitle: "關於coinglb",
        brandDetail: "誠實 | 公平 | 熱情 | 開放",
        brandDesc1: "coinglb 由一群比特幣早期參與者與極客創立，團隊核心成員來自於谷歌、微軟、阿里巴巴、騰訊等知名企業，具有深厚的研發實力與豐富的互聯網產品運營經驗。",
        brandDesc2: "coinglb 定位於區塊鏈基礎服務商，致力於為全球用戶提供優質加密資產交易平台，秉承著“不作惡”的基本原則，堅持誠實、公正、熱情的服務於客戶，以開放的態度迎接一切有利於用戶根本利益的伙伴/項目。",
        gettingstart: "新手入門 | 極速買幣",
        officialstart: "coinglb 官方新手入門輔助通道",
        oneminutebuy: "幣幣交易",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活動最終解釋權歸幣嚴(www.coinglb.com)官方所有",
        inputamount: "輸入兌換數量",
        ...
        submit: "提交",
        tipsmobile: "請進入電腦端頁面參與（www.coinglb.com）",
        tipsmobile1: "請在電腦端打開（www.coinglb.com）並進入創新實驗區參與",
        intvalue: "請輸入整數",
    ...
    invite: {
        ...
        partnerlevel: "合夥級別",
        ruledetail: "規則詳情",
        ruleprofile1: "幣嚴(www.coinglb.com)的【推廣合夥人】是全網",
        ruleprofile2: "返佣比例最高、",
        ruleprofile3: "返佣時長最長(最高終身返佣)",
        ruleprofile4: "的推廣活動，讓付出相應努力的推廣者能夠成為真正意義上的平台“合夥人”，享受與幣嚴(www.coinglb.com)交易平台共同成長的紅利！具體細則如下：",
        ruletext1: "一、為佈道數字資產理念與擴大用戶規模，幣嚴(www.coinglb.com)推出【推廣合夥人】計劃，該活動長期有效。",
        ...
        thanks: "感謝您陪著幣嚴coinglb一起成長！",
        headertip: "以上佣金數據非實時更新，系統每24H統計並更新一次。",
        ptools: "推廣工具箱",
        pt_title: "數字貨幣禮品卡",
        pt_desc: "兌換後自動成為下級好友，送朋友、送親人、送客戶、送夥伴。助力推廣合夥人更好推廣。",
        pt_more: "更多工具，敬請期待",
        pt_tips: "如果您有好的創意，請發送郵件至support@mailcenterservice.com，採納後有獎勵哦！",
        pt_card_amount: "卡面金額",
        ...
        pt_card_rule2: "二、免費禮品卡每個用戶限兌1份。由幣嚴(www.coinglb.com)官方發放的免費禮品卡，每個用戶限兌一份，即使通過不同用戶領取到不同兌換碼的免費禮品卡，也只能兌換1份。自定義製作禮品卡不受此限制。",
        ...
        pt_card_rule6: "六、免費禮品卡最終解釋權歸coinglb所有。",
        pt_card_day: "天",
    ...
    uc: {
        ...
        finance: {
            ...
            trade: {
                accumulative_return: '累計挖礦(CDEA) : ',
                accumulat_return: '待挖礦(CDEA) : ',
                start_end: '起止時間',
                account_date: '到帳時間',
                to: '至',
                operatetype: '操作類型',
            ...
            inviting: {
                accumulative_return: '邀請挖礦獎勵已返還累計(CDEA) : ',
                accumulat_return: '邀請挖礦獎勵待返還累計(CDEA) : ',
                start_end: '起止時間',
                account_date: '到帳時間',
                to: '至',
                operatetype: '操作類型',
    ...
    description: {
        ...
        // message3: 'coinglb數字資產交易平台支持每秒1000筆交易，給用戶帶來酣暢淋漓\n的交易體驗',
        title1: '金融級安全',
        title2: '極速充提',
        title3: '全球服務',
        title4: '嚴選資產',
        ...
        message5: '幣嚴(www.coinglb.com)國際數字加密資產交易平台手機客戶端，專注掌上交易體驗',
        scanqrcode: "掃描二維碼，下載APP",
        aboutdesc1: "幣嚴(www.coinglb.com)是技術全球領先的數字資產交易平台，註冊於開曼群島，核心運營團隊位於香港。幣嚴(www.coinglb.com)核心成員來自於頂級互聯網和金融公司，大部分成員是深度比特幣和區塊鏈信仰者，我們深信區塊鏈將改變傳統壟斷性金融體系，會建立一個更加民主、自治的社會結構。",
        aboutdesc2: "幣嚴(www.coinglb.com)平台擁有專業金融級別的交易架構，擁有自主研發的高並發內存撮合交易引擎，平台採用全冷充值錢包系統+多重簽名+高防護DDOS攻擊系統等交易架構，保證客戶資產安全。",
        aboutdesc3: "幣嚴(www.coinglb.com)為了讓客戶更好的把握投資機會，客服部門內部採用扁平化管理，建立了極速服務響應機制，資產客服經理常年7*24H在線，為客戶提供資產充值提現等服務，保障客戶在25分鐘內完成資產充提。",
        aboutdesc4: "幣嚴(www.coinglb.com)嚴格篩選優質項目並提供安全穩定的資產託管服務。幣嚴(www.coinglb.com)秉承著“誠實、公正、熱情、開放”的理念，竭力為用戶打造安全、可靠、高效和友好的極致交易所。",
        ...
        community: "CDEA 社區",
        wechat: "微信",
        addwechat: "添加 “coinglb” 為微信好友，進入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "幣用",
        telegram: "電報",
    ...
    bzb_description: {
        ...
        desc4: "參與coinglb社區投票活動，包括但不限於上幣、回購等",
    ...
    index: {
        ...
        CDEAregister: "coinglb賬戶註冊",
        tibi: "提幣到賬時間及限額",
        line_plane: "CDEA上線計劃、流通量及手續費返還公告",
        fenpeijizhi: '關於coinglb收入分配機制的說明',
        jiangli_jihua: "邀請挖礦獎勵計劃",
        friend_fanhuan: "邀請好友、賺取額外手續費返還"
    },
    plate: {
        title: "平台收入分配方案 (CDEA 持有者權益)",
        content1: "正如白皮書所描述的，coinglb會拿出平台的80% (扣除稅費後) 的收入分配給coinglb持有者，20%的收入用來支持平台的研發及運營。",
        content2: "收入分配以日為一個分配週期，2018年6月6日為首個分配日。之後的每一天，會將前一天累積的所有待分配收入，一次性的按比例分給CDEA持有者",
        content3: "（注：1.此處的CDEA僅指已經釋放的/可流通的CDEA，具體請參見【",
        content3_1: '關於CDEA流通量/參與收入分配比例的說明',
    ...
    feereturn: {
        ruletitle: "返還規則",
        rulecontent: "白皮書裡已經對CDEA的分配比例有詳細的說明。51%比例的CDEA通過“交易即挖礦”的方式逐步回饋給交易用戶。一旦51%的CDEA全部回饋完成，“挖礦”即自動終止。",
        recordtitle: '返還記錄',
        recordcontent: '每日（UTC+8，以下同）都會將前一日的用戶所產生交易手續費，100%折算成CDEA返還給用戶，折算價格按前一交易日CDEA的均價（均價計算方式為總成交金額/總成交量）。我們將於每日上午11點，開始發放前一日交易手續費折合CDEA的返還。 ',
        /*time:"日期",
        todaycharge:"當日coinglb均價(ETH)",
        totalChange:'當日總手續費折合(ETH)',
        returnCharge:"當日挖礦手續費返還(CDEA)",
        todayChargeReturn:"當日挖礦收入倍增計劃返還（CDEA）"*/
    }
}
