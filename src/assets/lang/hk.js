module.exports = {
    ...
    sectionPage: {
        ...
        brandDesc1: "c-deal 由一群比特幣早期參與者與極客創立，團隊核心成員來自於谷歌、微軟、阿里巴巴、騰訊等知名企業，具有深厚的研發實力與豐富的互聯網產品運營經驗。",
        brandDesc2: "c-deal 定位於區塊鏈基礎服務商，致力於為全球用戶提供優質加密資產交易平台，秉承著“不作惡”的基本原則，堅持誠實、公正、熱情的服務於客戶，以開放的態度迎接一切有利於用戶根本利益的伙伴/項目。",
        gettingstart: "新手入門 | 極速買幣",
        officialstart: "c-deal 官方新手入門輔助通道",
        oneminutebuy: "幣幣交易",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活動最終解釋權歸幣嚴(www.c-deal.com)官方所有",
        inputamount: "輸入兌換數量",
        ...
        submit: "提交",
        tipsmobile: "請進入電腦端頁面參與（www.c-deal.com）",
        tipsmobile1: "請在電腦端打開（www.c-deal.com）並進入創新實驗區參與",
        intvalue: "請輸入整數",
    ...
    invite: {
        ...
        partnerlevel: "合夥級別",
        ruledetail: "規則詳情",
        ruleprofile1: "幣嚴(www.c-deal.com)的【推廣合夥人】是全網",
        ruleprofile2: "返佣比例最高、",
        ruleprofile3: "返佣時長最長(最高終身返佣)",
        ruleprofile4: "的推廣活動，讓付出相應努力的推廣者能夠成為真正意義上的平台“合夥人”，享受與幣嚴(www.c-deal.com)交易平台共同成長的紅利！具體細則如下：",
        ruletext1: "一、為佈道數字資產理念與擴大用戶規模，幣嚴(www.c-deal.com)推出【推廣合夥人】計劃，該活動長期有效。",
        ...
        pt_card_rule2: "二、免費禮品卡每個用戶限兌1份。由幣嚴(www.c-deal.com)官方發放的免費禮品卡，每個用戶限兌一份，即使通過不同用戶領取到不同兌換碼的免費禮品卡，也只能兌換1份。自定義製作禮品卡不受此限制。",
        ...
        pt_card_rule6: "六、免費禮品卡最終解釋權歸c-deal所有。",
        pt_card_day: "天",
    ...
    description: {
        ...
        // message3: 'c-deal數字資產交易平台支持每秒1000筆交易，給用戶帶來酣暢淋漓\n的交易體驗',
        title1: '金融級安全',
        title2: '極速充提',
        title3: '全球服務',
        title4: '嚴選資產',
        ...
        message5: '幣嚴(www.c-deal.com)國際數字加密資產交易平台手機客戶端，專注掌上交易體驗',
        scanqrcode: "掃描二維碼，下載APP",
        aboutdesc1: "幣嚴(www.c-deal.com)是技術全球領先的數字資產交易平台，註冊於開曼群島，核心運營團隊位於香港。幣嚴(www.c-deal.com)核心成員來自於頂級互聯網和金融公司，大部分成員是深度比特幣和區塊鏈信仰者，我們深信區塊鏈將改變傳統壟斷性金融體系，會建立一個更加民主、自治的社會結構。",
        aboutdesc2: "幣嚴(www.c-deal.com)平台擁有專業金融級別的交易架構，擁有自主研發的高並發內存撮合交易引擎，平台採用全冷充值錢包系統+多重簽名+高防護DDOS攻擊系統等交易架構，保證客戶資產安全。",
        aboutdesc3: "幣嚴(www.c-deal.com)為了讓客戶更好的把握投資機會，客服部門內部採用扁平化管理，建立了極速服務響應機制，資產客服經理常年7*24H在線，為客戶提供資產充值提現等服務，保障客戶在25分鐘內完成資產充提。",
        aboutdesc4: "幣嚴(www.c-deal.com)嚴格篩選優質項目並提供安全穩定的資產託管服務。幣嚴(www.c-deal.com)秉承著“誠實、公正、熱情、開放”的理念，竭力為用戶打造安全、可靠、高效和友好的極致交易所。",
        ...
        community: "CDEA 社區",
        wechat: "微信",
        addwechat: "添加 “c-deal” 為微信好友，進入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "幣用",
        telegram: "電報",
    ...
    bzb_description: {
        ...
        desc4: "參與c-deal社區投票活動，包括但不限於上幣、回購等",
    ...
    index: {
        ...
        CDEAregister: "c-deal賬戶註冊",
        tibi: "提幣到賬時間及限額",
        line_plane: "CDEA上線計劃、流通量及手續費返還公告",
        fenpeijizhi: '關於c-deal收入分配機制的說明',
        jiangli_jihua: "邀請挖礦獎勵計劃",
        friend_fanhuan: "邀請好友、賺取額外手續費返還"
    },
    plate: {
        title: "平台收入分配方案 (CDEA 持有者權益)",
        content1: "正如白皮書所描述的，c-deal會拿出平台的80% (扣除稅費後) 的收入分配給c-deal持有者，20%的收入用來支持平台的研發及運營。",
