module.exports = {
    common: {
        ...
        headerImg:"Update Avatar",
        version:"Version number",
        settingTitle:"My settings",
        ...
        recharge:"Recharge",
        withdraw:"Withdraw",
        support:"Support BTC, USDT, ETH etc.",
        helpCenter:"Help Center",
        noticeCenter:"Notice Center",
        customerCenter:"Customer",
        innovativeLab:"Innovative Lab",
        innovativeLabDesc:"Open Laboratories for Win-win Cooperation among Investors, Projectors and Exchanges",
        trend:"Trend",
        marketTrend:"Market Trend",
        announcementlist:"Announcement list",
        announcementDetail:"Announcement detail",
        rechargeList:"Recharge List",
        rechargeChannels:"Please choose the following recharge channel.",
        rechargeTip:"Tip, the bank recharge interface is in development, will be comming soon.",
        rehargeThird:"Third-party recharge channel",
        goRecharge:"Recharge",
        thirdChannel:"offical recharge channel",
        rechargeAddress:"Recharge Address",
        rechargeCustomer:"Please look for online customer service to get address.",
        rechargeCopy:"Copy Address",
        rechargeAmount:"Recharge amount",
        rechargeEvidence:"Recharge Evidence",
        rechargeEvidenceTip:"Click to upload recharge image",
        rechargeSave:"Submit",
        withdrawList:"Withdraw List",
        withdrawChannels:"Please choose the following withdraw channel.",
        withdrawTip:"Tip: The bank withdraw interface is in development, will be coming soon.",
        goWithdraw:"Withdraw",
        withdrawThird:"Third-party withdraw channels",
        withdrawThirdChannel:"offical withdraw channel",
    ...
    sectionPage: {
        ...
        brandTitle: "About coinglb",
        brandDetail: "Honest  |  Fair  |  Enthusiasm  |  Open",
        brandDesc1: "coinglb is a global cryptocurrency exchange that provides a trading platform for over 80 cryptocurrencies. Since the beginning of 2018, coinglb has been regarded as the safest cryptocurrency exchange in the world in terms of transaction security.",
        brandDesc2: "coinglb is a basic blockchain service provider, dedicated to providing global users with a high-quality crypto asset trading platform, adhering to the basic principle of 'dont be evil', serving customers with honesty, fairness and enthusiasm, and welcoming all benefits with an open attitude Partners/projects of fundamental interest to the user.",
        gettingstart: "HOT | Beginner's Guide",
        officialstart: "coinglb Official Customer Service",
        ...
        exchangenew:"How to exchange",
        exchangenewtips:"How to buy and sell on exchange.",
        newuser:"User Community",
        newusertips:"Experience and Information sharing.",
    ...
    progress: {
        already: "Have to dig",
        total: "Amount of excavable ore 6 billion CDEA"
    },
    service: {
        USDT: 'USDT',
        BTC: 'BTC',
    ...
    exchange: {
        ...
        canuse: 'Available',
        recharge: 'Deposit',
        institutionalCode:'Please enter invitation code',
        buyprice: 'Buy Price',
        buynum: 'Buy Amount',
        amount: 'Amount',
        buyin: 'Buy',
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by CDEA, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    cexchange: {
        title: "CDEA Activity",
        desc: "CDEA Coin ● One-click ● Profit everyday",
        ...
        confirmmsg: "Are you sure to exchange CDEA?",
        ok: "OK",
        cancel: "Cancel"
    },
    option: {
    ...
    otc: {
        ...
        checkuser: {
            ...
            teldone: 'Mobile number certified',
            telundo: 'Mobile number unauthorized',
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of coinglb.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（www.coinglb.com）",
    ...
    invite: {
        ...
        mycommission: "Commission income",
        extrareward: "Additional rewards",
        partnerlevel: "Partnership level",
        ruledetail: "Rule details",
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with CDEA trading platform. Detailed rules are as follows:",
        ruleprofile2:"",
        ruleprofile3:"",
        ruleprofile4:"",
        ruletext1: "1、In order to preach the concept of digital assets and expand the scale of users, coinglb launched the “Promotion Partner” program, which is effective for a long time.",
        ...
        ruletext11: "11、The right of final interpretation of this activity belongs to coinglb.",
        ...
        thanks: "Thank you for supporting coinglb!",
        ...
        pt_tips: "If you have a good idea, please send an email to support@mailcenterservice.com, with a reward after adoption.！",
        pt_card_amount: "Card Amount",
        pt_card_deadline: "DeadLine",
        pt_card_noend: "Indefinite",
        pt_card_btn: "Get 30 cards for free(≈2000 THB)",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to coinglb.",
        pt_card_day: "Days",
        pt_card_title_tips: "Free promotion grant of 2000 THB",
    ...
    uc: {
        ...
        finance: {
            ...
            secondsAssets: 'Seconds Assets',
            billdetail: 'Bill Detail',
            charge: 'Recharge',
            pickup: 'Withdrawal',
            paymentEvidence:"Recharge Evidence",
            ...
            seconds:{
                tradeModel:"Trade type",
                startTime:"Open time",
                profitRate:"Profit rate",
                balance:"Balance",
                buyAmount:"Buy amount",
                secondsaccount: "Seconds Account",
                secondsAssets: "Second Contract Assets",
                seconds: " Seconds Account",
                compensate:"Compensate Type",
                compensateNo:"No",
                compensateYes:"Yes",
                openPrice:"Open Price",
                periodTime:"Period",
            ...
            trade: {
                accumulative_return: 'Mining fees have been repaid (CDEA) : ',
                accumulat_return: 'Mining fees should be repaid(CDEA) : ',
                start_end: 'Start-End',
            ...
            inviting: {
                accumulative_return: 'Inviting mining rewards has been returned and accumulated(CDEA) : ',
                accumulat_return: 'Invite mining awards to be returned(CDEA) : ',
                account_date: 'Time for receiving the capital',
                start_end: 'Start-End',
                to: 'To',
                operatetype: 'Action Type',
        ...
        regist: {
            ...
            regist: 'Sign up',
            teltip: 'Enter mobile',
            telerr: 'Mobile format error,enter again',
            emailtip: 'Enter email',
            ...
            promotion: 'Invitation Code(Optional)',
            promotionrequired: 'Invitation Code',
			china: 'china',
            singapore: 'singapore',
            korea: 'korea',
            japan: 'japan',
        ...
        identity: {
            ...
            become: "Become CDEA Certified Business and enjoy more transaction privileges",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "CDEA APP - Trade everywhere."
    },
    description: {
        title1: 'Security',
        title2: '24H Service',
        ...
        aboutdesc1: "coinglb is a leading digital asset trading platform in the world, registered in the Cayman Islands, with a core operating team in Hong Kong. The core members of coinglb come from top Internet and financial companies. Most of them are deep believers in Bitcoin and block chains. We are convinced that block chains will change the traditional monopolistic financial system and build a more democratic and autonomous social structure.",
        aboutdesc2: "coinglb platform has a professional financial-level trading architecture, a self-developed high concurrent memory matching trading engine. The platform uses a full-cold rechargeable wallet system + multiple signatures + high-protection DDOS attack system and other trading architecture to ensure customer asset security.",
        aboutdesc3: "In order to let customers better grasp the investment opportunities, coinglb adopts flat management in customer service department, and establishes an extremely fast service response mechanism. The asset customer service manager is on-line 7*24H all the year round, providing customers with services such as recharge and cash of assets, and ensuring that customers complete recharge in 25 minutes.",
        aboutdesc4: "coinglb strictly screens high-quality projects and provides secure and stable asset hosting services. coinglb upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
        ...
        wechat: "Wechat",
        addwechat: "Add 'coinglb' as Wechat friends and then enter Wechat community",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        telegram: "Telegram",
    ...
    index: {
        ...
        CDEAregister: "CDEA account registration",
        tibi: "The time and limit of the payment of the money to the bill",
        line_plane: "Announcement on CDEA's on-line plan, circulation and service fee return",
        fenpeijizhi: 'A description of the CDEA income distribution mechanism',
        jiangli_jihua: "Inviting the mining Award Scheme",
        friend_fanhuan: "Invite friends, earn extra fee and return"
    },
    plate: {
        title: "Platform income distribution scheme（CDEA Holder's equity）",
        content1: "As described in the white paper, CDEA will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to CDEA holders, and 20% of revenue is used to support R & D and operation of the platform.",
        content2: "The distribution of income takes days as a distribution cycle, and June 6, 2018 as the first distribution day. Every day after that, the total income to be distributed on the previous day will be allocated to CDEA holders in proportion.",
        content3: "（notice：1. the CDEA here only refers to the CDEA that has been released / circulated. See also【",
        content3_1: 'Note on the ratio of CDEA circulation / participation in income distribution',
    ...
    feereturn: {
        ruletitle: "Note",
        rulecontent: 'Our White Paper has a detailed explanation of Reimbursement of Transaction Fees. Overall, 51% of the platform' + 's total CDEA base (referred to as "community reward portion" from now on) will be reimbursed to users over time via our "Trans-Fee Mining" mechanism. However once this 51% of the total CDEAs has been fully released via reimbursement, the "Trans-Fee Mining" mechanism will automatically end. ',
        recordtitle: 'List',
        recordcontent: 'Everyday (UTC+8, same as below) CDEA will reimburse 100% of the users' + 'transaction fees incurred from the previous day in the form of CDEA. This will be done by using the average CDEA price of the previous day (this average price is calculated as total value transacted/total volume transacted). We will complete this reimbursement of transaction fees from the previous day in the form of CDEAs, at 11am everyday.',
        time: "Date",
        todaycharge: "Average price (ETH)",
        totalChange: 'Total (ETH)',
        returnCharge: "Trans-Fee Mining reimbursement(CDEA)",
        todayChargeReturn: "Incentive Program for FCoin reimbursement（CDEA）"
    }
}
