module.exports = {
    ...
    sectionPage: {
        ...
        newsTitle: '多终端APP',
        brandTitle: "关于coinglb",
        brandDetail: "诚实 | 公平 | 热情 | 开放",
        brandDesc1: "coinglb是一家全球性的加密货币交易所，为超过80种加密货币提供交易平台。2018年初以来，coinglb在交易安全方面被认为是全世界上最安全的加密货币交易所。",
        brandDesc2: "coinglb是区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。",
        gettingstart: "新手入门 | 极速买币",
        officialstart: "coinglb官方新手入门辅助通道",
        oneminutebuy: "币币交易",
    ...
    ctc: {
        ...
        desc:"由coinglb平台托管数字资产，保障用户资产安全",
        buyin: "买入",
        sell: "卖出",
        buyprice: "买入价",
        sellprice: "卖出价",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归coinglb官方所有",
        inputamount: "输入兑换数量",
        ...
        submit: "提交",
        tipsmobile: "请进入电脑端页面参与（www.coinglb.com）",
        tipsmobile1: "请在电脑端打开（www.coinglb.com）并进入创新实验区参与",
        intvalue: "请输入整数",
    ...
    invite: {
        ...
        partnerlevel: "合伙级别",
        ruledetail: "规则详情",
        ruleprofile1:"coinglb的【推广合伙人】是全网",
        ruleprofile2:"返佣比例最高、",
        ruleprofile3:"返佣时长最长(最高终身返佣)",
        ruleprofile4:"的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与coinglb交易平台共同成长的红利！具体细则如下：",
        ruletext1: "一、为布道数字资产理念与扩大用户规模，coinglb推出【推广合伙人】计划，该活动长期有效。",
        ...
        thanks: "感谢您陪着coinglb一起成长！",
        headertip: "以上佣金数据非实时更新，系统每24H统计并更新一次。",
        ptools: "推广工具箱",
        pt_title: "数字货币礼品卡",
        pt_desc: "兑换后自动成为下级好友，送朋友、送亲人、送客户、送伙伴。助力推广合伙人更好推广。",
        pt_more: "更多工具，敬请期待",
        pt_tips: "如果您有好的创意，请发送邮件至support@mailcenterservice.com，采纳后有奖励哦！",
        pt_card_amount: "卡面金额",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由coinglb官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归www.coinglb.com所有。",
        pt_card_day: "天",
    ...
    uc: {
        ...
        finance: {
            ...
            trade: {
                accumulative_return: '累计挖矿(CDEA) : ',
                accumulat_return: '待挖矿(CDEA) : ',
                start_end: '起止时间',
                account_date: '到帐时间',
                to: '至',
                operatetype: '操作类型',
            ...
            inviting: {
                accumulative_return: '邀请挖矿奖励已返还累计(CDEA) : ',
                accumulat_return: '邀请挖矿奖励待返还累计(CDEA) : ',
                start_end: '起止时间',
                account_date: '到帐时间',
                to: '至',
                operatetype: '操作类型',
    ...
    cms: {
        ...
        scanforshare: "扫一扫分享",
        download: "立即下载",
        downloadslogan: "coinglb APP - 全球数字资产交易平台"
    },
    description: {
        // message1: 'SSL、动态身份验证等银行级别安全技术，\n保障交易安全；支持多种数字货币交易',
        // message2: '严格的项目准入门槛，确保平台用户利益；\n100%保证金，钱包冷热隔离，确保用户资金安全',
        // message3: 'CDEA数字资产交易平台支持每秒1000笔交易，给用户带来酣畅淋漓\n的交易体验',
        title1: '金融级安全',
        title2: '极速充提',
        title3: '全球服务',
        title4: '严选资产',
        ...
        message5: 'coinglb国际数字加密资产交易平台手机客户端，专注掌上交易体验',
        scanqrcode: "扫描二维码，下载APP",
        aboutdesc1: "coinglb是技术全球领先的数字资产交易平台，注册于开曼群岛，核心运营团队位于香港。coinglb核心成员来自于顶级互联网和金融公司，大部分成员是深度比特币和区块链信仰者，我们深信区块链将改变传统垄断性金融体系，会建立一个更加民主、自治的社会结构。",
        aboutdesc2: "coinglb平台拥有专业金融级别的交易架构，拥有自主研发的高并发内存撮合交易引擎，平台采用全冷充值钱包系统+多重签名+高防护DDOS攻击系统等交易架构，保证客户资产安全。",
        aboutdesc3: "coinglb为了让客户更好的把握投资机会，客服部门内部采用扁平化管理，建立了极速服务响应机制，资产客服经理常年7*24H在线，为客户提供资产充值提现等服务，保障客户在25分钟内完成资产充提。",
        aboutdesc4: "coinglb严格筛选优质项目并提供安全稳定的资产托管服务。coinglb秉承着“诚实、公正、热情、开放”的理念，竭力为用户打造安全、可靠、高效和友好的极致交易所。",
        ...
        community: "CDEA 社区",
        wechat: "微信",
        addwechat: "添加 “CDEA601” 为微信好友，进入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "币用",
        telegram: "电报",
    ...
    bzb_description: {
        ...
        desc4: "参与CDEA社区投票活动，包括但不限于上币、回购等",
    ...
    index: {
        circulation: "CDEA 安全与发展基金流通量",
        hourEth: '今日待分配收入累计折合',
        yesterdayEth: '昨日分配收入累计折合',
        yesterday: '昨日挖矿产出',
        CDEATotal: "CDEA 总流通量",
        CDEASecond: "CDEA二级市场流通量",
        checkMineprinciple: "查看挖矿原理",
        checkFlowVolum: '检查流通量说明',
        checkLockPosition: '查看锁仓情况',
        CDEAregister: "CDEA账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "CDEA上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于CDEA收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (CDEA 持有者权益)",
        content1: "正如白皮书所描述的，CDEA会拿出平台的80% (扣除税费后) 的收入分配给CDEA持有者，20%的收入用来支持平台的研发及运营。",
        content2: "收入分配以日为一个分配周期，2018年6月6日为首个分配日。之后的每一天，会将前一天累积的所有待分配收入，一次性的按比例分给CDEA持有者",
        content3: "（注：1.此处的CDEA仅指已经释放的/可流通的CDEA，具体请参见【",
        content3_1: '关于CDEA流通量/参与收入分配比例的说明',
    ...
    feereturn: {
        ruletitle: "返还规则",
        rulecontent: "白皮书里已经对CDEA的分配比例有详细的说明。51%比例的CDEA通过“交易即挖矿”的方式逐步回馈给交易用户。一旦51%的CDEA全部回馈完成，“挖矿”即自动终止。",
        recordtitle: '返还记录',
        recordcontent: '每日（UTC+8，以下同）都会将前一日的用户所产生交易手续费，100%折算成CDEA返还给用户，折算价格按前一交易日CDEA的均价（均价计算方式为总成交金额/总成交量）。我们将于每日上午11点，开始发放前一日交易手续费折合CDEA的返还。',
        /*time:"日期",
        todaycharge:"当日CDEA均价(ETH)",
