<template>
  <div class="page-kline-list" :style="{'z-index':!isShowKline?-100:100}" :class="{'isShowAppDownload': isShowAppDownload=='0'}">
    <PageHeader :headerType=2 :title="currentCoin.symbol+' Kline'"></PageHeader> 
...
export default {
  ...
  computed: {
    ...
    isShowKline(){
      return this.$store.state.isShowKline;
    },
    lang: function() {
