        ...
        <section>
          <div class="table-inner">
            <div class="action-inner">
              ...
              <div class="inner-box deposit-address mt25">
                <p class="describe">Internal system withdraw?</p>
                <div class="title withdraw-title">
                  <i-switch v-model="address_type" @on-change="addressTypeChange" size="large"></i-switch>
                </div>
              </div>
            </div>
            <div class="action-inner">
...
export default {
  ...
  methods: {
    addressTypeChange(address_type){
    ...
    submit(name) {
      ...
      // param["address_type"] = this.address_type?1:0;
