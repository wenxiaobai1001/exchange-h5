                    ...
                    <div class="account-in">
                        ...
                        <div class="account-item" >
                            ...
                            <div class="account-detail" v-show="choseItem==2">
                                <div class="detail-list" style="width: 100%;">
                                    <Form ref="formValidate2" label-position="top" :model="formValidate2" :rules="ruleValidate" :label-width="180">
                                        <!-- mail -->
                        ...
                        <div class="account-item">
                            ...
                            <div class="account-detail" v-show="choseItem==4">
                                <div class="detail-list" style="width: 100%;">
                                    <Form ref="formValidate4" :model="formValidate4" :rules="ruleValidate" :label-width="180">
                                        <!-- oldPw -->
                        ...
                        <div class="account-item">
                            ...
                            <div class="account-detail" v-show="choseItem==5">
                                ...
                                <div class="detail-list" style="width: 100%;" v-show="user.fundsVerified!=1">
                                    <Form ref="formValidate7" :model="formValidate7" :rules="ruleValidate" :label-width="180">
                                        <!-- newMPw -->
                                ...
                                <div class="detail-list" style="width: 100%;" v-show="user.fundsVerified==1  && !fGetBackFundpwd">
                                    <Form ref="formValidate5" :model="formValidate5" :rules="ruleValidate" :label-width="180">
                                        <!-- oldPw -->
                                ...
                                <!-- 找回 -->
                                <div class="detail-list" style="width: 100%;" v-show="user.fundsVerified==1 && fGetBackFundpwd">
                                    <Form ref="formValidate8" :model="formValidate8" :rules="ruleValidate" :label-width="180">
                                        <!-- newMPw -->
