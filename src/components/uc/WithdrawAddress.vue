          ...
          <div class="table-inner">
            <div class="action-inner">
              <div class="inner-left">
                ...
                <Select v-model="coinType" style="width:100px;" size="large" :placeholder="$t('common.pleaseselect')">
              ...
              <div class="inner-box deposit-address mt25">
                ...
                <div class="title">
                  <Input v-model="withdrawAddr" size="large"></Input>
                </div>
              </div>
              <div class="mt25">
                <p class="describe">{{$t('uc.finance.withdraw.remark')}} / Memo</p>
                <div class="title">
                  <Input v-model="remark" style="width:100%;" size="large"></Input>
                </div>
              </div>
            </div>
            <div class="btnbox">
