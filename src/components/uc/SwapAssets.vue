          ...
          <div class="money_table">
            <div style="width: 100%;">
              <div style="float:left;letter-spacing:1px;padding-top: 5px;">
                  ...
                  <!-- <span style="font-size:12px;color:#828ea1;margin-left: 5px;"> ≈ ¥{{totalCny}}</span> -->
              </div>
              <!-- <Input class="search" search :placeholder="$t('common.searchplaceholder')" @on-change="seachInputChange" v-model="searchKey"></Input> -->
              <Button type="primary" @click="onTransferClick" style="padding: 6px 15px;letter-spacing:2px;color:#f0ac19;background-color:transparent;border:1px solid #f0ac19;margin-bottom: 10px;width: 150px;font-size: 18px; font-weight: bold;">{{$t('uc.finance.swap.transfor')}}</Button>
            </div>
