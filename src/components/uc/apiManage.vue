  ...
  <div class="nav-rights">
    <div class="main api-manage">
      ...
      <Card :bordered="false" class="content">
        ...
        <Table :no-data-text="$t('common.nodata')" :columns="myColumns" :data="tableData"></Table>
      </Card>
    </div>
    <!--编辑API-->
  ...
  computed: {
    myColumns() {
      ...
      arr.push({
        ...
        // width: 100,
        width: this.locale == 'en_US' ? 120 : 100,
        key: "createTime"
      });
      arr.push({
      ...
      arr.push({
        ...
        width: this.locale == 'en_US' ? 130 : 100,
        render: (h, params) => {
          const text = "******";
          return h("span", {}, text);
        }
