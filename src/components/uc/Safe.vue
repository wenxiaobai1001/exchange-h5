                    ...
                    <div class="account-in">
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <p v-if="user.realVerified==1" class="bankInfo" style="color: #fff;font-size: 12px;">{{user.realName}}</p>
                                <p v-else-if="user.realVerified==0&&user.realAuditing==0&&user.realNameRejectReason!=null" class="bankInfo" style="color: #f0a70a;font-size: 12px;">审核未通过{{user.realNameRejectReason?"："+user.realNameRejectReason:""}}，请重试。</p>
                                <p v-else class="bankInfo" style="color: #828ea1;font-size: 12px;">{{$t('uc.safe.verifiedtip')}}</p>

                                <span class="verified-btn" v-if="user.realVerified==1">{{$t('uc.safe.verifypass')}}</span>
                                <span class="verified-btn" v-else-if="user.realAuditing==1">{{$t('uc.safe.binding')}}</span>
                            ...
                            <div class="account-detail" v-show="choseItem==6">
                                <div class="detail-list" style="width: 100%;">
                                    <Form ref="formValidate6" label-position="top" :model="formValidate6" :rules="ruleValidate" style="text-align:center;">
                                        <!-- 真实姓名 -->
                                        ...
                                        <FormItem style="text-align:center;">
                                            <Button type="warning" @click="handleSubmit('formValidate6')">{{$t('uc.safe.save')}}</Button>
                                            <Button @click="handleReset('formValidate6')">{{$t('uc.safe.reset')}}</Button>
                                        </FormItem>
                                    </Form>
                                </div>
                            </div>
                        ...
                        <div class="account-item" >
                            <div class="account-item-in">
                                ...
                                <p v-if="user.emailVerified==1" class="bankInfo" style="color:#828ea1;font-size: 12px;">{{user.email}}</p>
                                <p v-else class="bankInfo" style="color: #828ea1;font-size: 12px;">{{$t('uc.safe.bindemail')}}</p>
                                
                                <span class="verified-btn" v-if="user.emailVerified==1">{{$t('uc.safe.binded')}}</span>
                                <a v-else class="btn" @click="showItem(2)">{{$t('uc.safe.bind')}}</a>
                            </div>
                            <div class="account-detail" v-show="choseItem==2">
                                <div class="detail-list" style="width: 100%;">
                                    <Form ref="formValidate2" label-position="top" :model="formValidate2" :rules="ruleValidate" >
                                        <!-- mail -->
                                        ...
                                        <FormItem :label="$t('uc.safe.emailcode')" prop="vailCode1">
                                            <Input v-model="formValidate2.vailCode1" size="large" class="send-sms-custom">
                                        ...
                                        <FormItem style="text-align:center;">
                                            ...
                                            <Button @click="handleReset('formValidate2')">{{$t('uc.safe.reset')}}</Button>
                                        </FormItem>
                                    </Form>
                                </div>
                            </div>
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <p v-if="user.phoneVerified==1" class="bankInfo" style="color: #fff;font-size: 12px;">{{user.mobilePhone}}</p>
                                <p v-else class="bankInfo" style="color: #828ea1;font-size: 12px;">{{$t('uc.safe.bindphone')}}</p>
                                
                                <span class="verified-btn" v-if="user.phoneVerified==1">{{$t('uc.safe.binded')}}</span>
                                <a v-else class="btn" @click="showItem(3)">{{$t('uc.safe.bind')}}</a>
                            </div>
                            <div class="account-detail" v-show="choseItem==3">
                                <div class="detail-list" style="width: 100%;">
                                    <Form ref="formValidate3" label-position="top" :model="formValidate3" :rules="ruleValidate">
                                        <FormItem :label="$t('uc.safe.country')" prop="country">
                                            <Select filterable v-model="formValidate3.country" style="width: 100%;border-bottom: 1px solid #27313e;">
                                        ...
                                        <FormItem :label="$t('uc.safe.phonecode')" prop="vailCode2">
                                            <Input v-model="formValidate3.vailCode2" size="large" class="send-sms-custom">
                                            <!-- <Button slot="append">点击获取</Button> -->
                                            <div class="timebox" slot="append">
                                        ...
                                        <FormItem style="text-align:center;">
                                            ...
                                            <Button @click="handleReset('formValidate3')">{{$t('uc.safe.reset')}}</Button>
                                        </FormItem>
                                    </Form>
                                </div>
                            </div>
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <p class="bankInfo" style="color: #828ea1;font-size: 12px;">{{$t('uc.safe.logintip')}}</p>
                            ...
                            <div class="account-detail" v-show="choseItem==4">
                                <div class="detail-list" style="width: 100%;">
                                    <Form ref="formValidate4" label-position="top" :model="formValidate4" :rules="ruleValidate">
                                        <!-- oldPw -->
                                        ...
                                        <FormItem :label="$t('uc.safe.phonecode')" prop="vailCode3">
                                            <Input v-model="formValidate4.vailCode3" size="large" class="send-sms-custom">
                                            <!-- <Button slot="append">点击获取</Button> -->
                                            <div class="timebox" slot="append">
                                        ...
                                        <FormItem style="text-align:center;">
                                            ...
                                            <Button @click="handleReset('formValidate4')">{{$t('uc.safe.reset')}}</Button>
                                        </FormItem>
                                    </Form>
                                </div>
                            </div>
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                              <Icon type="logo-bitcoin" size="20" color="#00b5f6" />
                                ...
                                <p class="bankInfo" style="color: #828ea1;font-size: 12px;">
                                    {{$t('uc.safe.fundtip')}}
                                </p>
                            ...
                            <div class="account-detail" v-show="choseItem==5">
                                <!-- 设置 -->
                                <div class="detail-list" style="width: 100%;" v-show="user.fundsVerified!=1">
                                    <Form ref="formValidate7" label-position="top" :model="formValidate7" :rules="ruleValidate">
                                        <!-- newMPw -->
                                ...
                                <!-- 修改 -->
                                <div class="detail-list" style="width: 100%;" v-show="user.fundsVerified==1  && !fGetBackFundpwd">
                                    <Form ref="formValidate5" label-position="top" :model="formValidate5" :rules="ruleValidate">
                                        <!-- oldPw -->
                                        ...
                                        <!-- <FormItem :label="$t('uc.safe.phonecode')" prop="vailCode5">
                                          <Input v-model="formValidate5.vailCode5" size="large" class="send-sms-custom">
                                            <div class="timebox" slot="append">
                                        ...
                                        <p style="text-align:right;">
                                            <!-- <a @click="handleReset('formValidate8');fGetBackFundpwd=!fGetBackFundpwd" style="color:#f0ac19;">Forget Password?</a> -->
                                        </p>
                                        <!-- Button -->
                                        <FormItem style="text-align:center;">
                                ...
                                <!-- 找回 -->
                                <div class="detail-list" style="width: 100%;" v-show="user.fundsVerified==1 && fGetBackFundpwd">
                                    <Form ref="formValidate8" label-position="top" :model="formValidate8" :rules="ruleValidate">
                                        <!-- newMPw -->
                                        ...
                                        <!-- 邮箱验证码 -->
                                        <FormItem :label="$t('uc.safe.phonecode')" prop="vailCode5">
                                            <Input v-model="formValidate8.vailCode5" size="large" class="send-sms-custom">
                                            <div class="timebox" slot="append">
                                                <Button @click="send(5)" :disabled="sendMsgDisabled5">
                                                    <span v-if="sendMsgDisabled5">{{time5+$t('uc.safe.second')}}</span>
                                                    <span v-if="!sendMsgDisabled5">{{$t('uc.safe.clickget')}}</span>
                                        ...
                                        <FormItem style="text-align:center">
                                            ...
                                            <Button  @click="handleReset('formValidate8')">{{$t('uc.safe.reset')}}</Button>
                                        </FormItem>
                                    </Form>
                                </div>
                            </div>
  ...
  methods: {
    ...
    getAreas() {
      this.$http.post(this.host + this.api.common.area).then(response => {
        ...
        this.formValidate3.country = this.areas[0].zhName;
        this.formValidate3.areaCode = this.areas[0].areaCode;
      });
    },
    getMember() {
      //获取个人安全信息
...
.detail-list {
  ...
  /deep/ .ivu-form-item-content > button {
    font-size: 14px;
    width: 100px;
  }
}
